...
public class preset_profile_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preset_profile1);
        myAudioManager = (AudioManager)getSystemService(Context.AUDIO_SERVICE);
        mediaVolume = findViewById(R.id.preset1_music_volume_index);
        voicecallVolume = findViewById(R.id.preset1_voice_call_volume_index);
        ringVolume = findViewById(R.id.preset1_ring_volume_index);
        notificationVolume = findViewById(R.id.preset1_notification_volume_index);
        alarmVolume = findViewById(R.id.preset1_alarm_volume_index);
        presetName = findViewById(R.id.text_preset_profile_1);

        mediaSB = findViewById(R.id.preset1_musicVolumeSB);
        voicecallSB = findViewById(R.id.preset1_voiceCallVolumeSB);
        ringSB = findViewById(R.id.preset1_ringVolumeSB);
        notificationSB = findViewById(R.id.preset1_notificationVolumeSB);
        alarmSB = findViewById(R.id.preset1_alarmVolumeSB);

        saveButton = findViewById(R.id.preset1_button);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot childSnapshot : snapshot.getChildren()) {
                        ...
                        if (childSnapshot.hasChild(preset1Name)) {
                            ...
                            childUpdates.put(presetID + "/" + preset1Name, myVolumeClassUpdate);
                ...
                if (!presetExists) {
                    ...
                    referenceProfile.child(presetID).child(preset1Name).setValue(myVolumeClass);
