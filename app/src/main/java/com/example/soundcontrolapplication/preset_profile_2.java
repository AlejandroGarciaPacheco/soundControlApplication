...
public class preset_profile_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preset_profile2);

        myAudioManager = (AudioManager)getSystemService(Context.AUDIO_SERVICE);
        mediaVolume = findViewById(R.id.preset2_music_volume_index);
        voicecallVolume = findViewById(R.id.preset2_voice_call_volume_index);
        ringVolume = findViewById(R.id.preset2_ring_volume_index);
        notificationVolume = findViewById(R.id.preset2_notification_volume_index);
        alarmVolume = findViewById(R.id.preset2_alarm_volume_index);
        presetName = findViewById(R.id.text_preset_profile_2);

        mediaSB = findViewById(R.id.preset2_musicVolumeSB);
        voicecallSB = findViewById(R.id.preset2_voiceCallVolumeSB);
        ringSB = findViewById(R.id.preset2_ringVolumeSB);
        notificationSB = findViewById(R.id.preset2_notificationVolumeSB);
        alarmSB = findViewById(R.id.preset2_alarmVolumeSB);

        saveButton = findViewById(R.id.preset2_button);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot childSnapshot : snapshot.getChildren()) {
                        ...
                        if (childSnapshot.hasChild(preset2Name)) {
                            ...
                            childUpdates.put(presetID + "/" + preset2Name, myVolumeClassUpdate);
                ...
                if (!presetExists) {
                    ...
                    referenceProfile.child(presetID).child(preset2Name).setValue(myVolumeClass);
