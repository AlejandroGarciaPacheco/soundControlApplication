...
public class preset_profile_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preset_profile3);

        myAudioManager = (AudioManager)getSystemService(Context.AUDIO_SERVICE);
        mediaVolume = findViewById(R.id.preset3_music_volume_index);
        voicecallVolume = findViewById(R.id.preset3_voice_call_volume_index);
        ringVolume = findViewById(R.id.preset3_ring_volume_index);
        notificationVolume = findViewById(R.id.preset3_notification_volume_index);
        alarmVolume = findViewById(R.id.preset3_alarm_volume_index);
        presetName = findViewById(R.id.text_preset_profile_3);

        mediaSB = findViewById(R.id.preset3_musicVolumeSB);
        voicecallSB = findViewById(R.id.preset3_voiceCallVolumeSB);
        ringSB = findViewById(R.id.preset3_ringVolumeSB);
        notificationSB = findViewById(R.id.preset3_notificationVolumeSB);
        alarmSB = findViewById(R.id.preset3_alarmVolumeSB);

        saveButton = findViewById(R.id.preset3_button);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot childSnapshot : snapshot.getChildren()) {
                        ...
                        if (childSnapshot.hasChild(preset3Name)) {
                            ...
                            childUpdates.put(presetID + "/" + preset3Name, myVolumeClassUpdate);
                ...
                if (!presetExists) {
                    ...
                    referenceProfile.child(presetID).child(preset3Name).setValue(myVolumeClass);
